...
import { searchVisibilityDesktop, searchVisibilityMobile } from "../helpers/search-input/search-visibility-deriver";
...
const MainLayout = () => {
  ...
  return (
    <MainLayoutWrapper>
      {
        isMobile &&
        isSearchIsVisibleMobile &&
        <NavigationMobile/>
      }
      {
        !isMobile &&
        <NavigationDesktop isSearchVisible={ isSearchVisible }/>
      }
      <Routes>
